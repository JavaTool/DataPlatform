 ...
 * @author 	fuhuiyuan
 */
public class CacheOnShardedRedis extends CacheOnJedis<ShardedJedis, ShardedJedis> implements ICache, ICounter {
    ...
    protected void setRedisHosts(String redisHostContent, int max){
        ...
        List<JedisShardInfo> jedisShards = Lists.newArrayList();
